...
<header>
  <nav class="navbar navbar-default">
    ...
    <div class="navbar-header"><a class="navbar-brand" href="bmselect.php">データ一覧</a></div>
    </div>
  </nav>
</header>
<!-- Head[End] -->
...
<form method="post" action="bmupdate.php">
  <div class="jumbotron">
   <fieldset>
    <legend>更新：BookMark/legend>
     <label>書籍名：<input type="text" name="name" value="<?=$row["name"]?>"></label><br>
     <label>URL：<input type="text" name="email" value="<?=$row["email"]?>"></label><br>
